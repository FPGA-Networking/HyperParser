...
# 预处理，删除 全0、全1、重复列，以及冗余列（两列实现功能相同）
# print(exe_path+' '+dirname+'/PreProcess.py')
os.system(exe_path+' '+dirname+'/PreProcess.py')
os.system(exe_path+' '+dirname+'/bit_selection.py')
